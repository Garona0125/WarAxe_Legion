...
class npc_94731 : public CreatureScript
{
public:
	npc_94731() : CreatureScript("npc_94731") {}

	CreatureAI* GetAI(Creature* creature) const override
	{
		return new npc_94731AI(creature);
	}
	struct npc_94731AI : public ScriptedAI
	{
		npc_94731AI(Creature* creature) : ScriptedAI(creature) {}

		void MoveInLineOfSight(Unit* who) override
		{
			if (who->GetDistance(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ()) < 10.0f)
			{
				if (me->GetPositionX() == 1362 && me->GetPositionY() == -263)
				{
