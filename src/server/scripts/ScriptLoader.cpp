...
{
#ifdef SCRIPTS
	AddSC_hellfire_assault();
	AddSC_boss_archimonde_hc();
	AddSC_boss_fel_lord_zakuun();
	AddSC_boss_gorefiend_hc();
	AddSC_boss_hellfire_council();
	AddSC_boss_iron_reaver();
	AddSC_boss_kilrogg_deadeye();
	AddSC_boss_kormrok();
	AddSC_boss_mannoroth_hc();
	AddSC_boss_shadowlord_iskar();
	AddSC_boss_socrethar_the_eternal();
